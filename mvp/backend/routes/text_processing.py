""" "
This module contains the routes for processing text data.
It had been adapted from the original codebase to include only the necessary imports and functions.
- All user related routes have been removed.
- Throttles have been removed.
- Processing time is shown in relation to the different stages of the text processing.
