...
export default function Document({props}) {
  ...
  const [keywords, setKeywords] = useState(['molestie', 'rutrum']);
  const { id } = useParams();
  ...
  useEffect(() => {
    async function fetchDocument() {
        return setDocument(getExampleDocument());
      ...
      {document ? (
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-row '>
                ...
                <div contentEditable='true' className='flex flex-col bg-white p-4 shadow-md rounded'
                    style={{
                        width: '100%',
                        minHeight: '90vh',
                        margin: '10px',
